...
public class AddRecordActivityTest {
    ...
    @Rule
    public ActivityTestRule<AddRecordActivity> addRecordActivityTestRule = new ActivityTestRule<>(AddRecordActivity.class);
    private AddRecordActivity addRecordActivity = null;

    @Before
    public void setUp() throws Exception {
        addRecordActivity = addRecordActivityTestRule.getActivity();
    }

    @Test
    public void testAddRecord() throws Exception{
        EditText HL = addRecordActivity.findViewById(R.id.headline);
        assertNotNull(HL);
        String UserID;
        UserID = "Testpatient";
