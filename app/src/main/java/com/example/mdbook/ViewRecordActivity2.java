...
public class ViewRecordActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_record2);
        ...
        mAdapter = new RecordAdapter(recordList,ViewRecordActivity2.this);
